...
def _system_prompt() -> str:
    return (
        ...
        "content yourself: it matches by meaning as well as literal text. "
        "When the paper is written in a different language than the question, "
        "search in both languages and prefer the paper's language for topical "
        "terms. For chapter, section, or structure questions (for example 'what "
        "does chapter 3 cover' or 'list the paper's sections'), call "
        "list_sections first to find the right section id, then read_section "
        "to read that section together with its subsections before answering. "
        "For broad or summary questions (e.g. what the paper is "
